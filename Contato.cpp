...
int main(int argc, char** argv)
{
	...
	cout << "Nome das pessoas com idade superior a media: " << endl;
	for(int i = 0; i < 10; i++)
	{
	...
	cout << "A quantidade de pessoas maiores de idade: " << qtdMaioridade << endl;
	cout << endl;

	//exibir os dados do(s) mais velho(s)
	for(int i = 0; i < 10; i++)
	{
	...
	cout << "Dado(s) da(s) pessoa(s) com a maior idade: " << endl;
	for(int i = 0; i < 10; i++)
	{
		if(contatos[i].idade() == maiorIdade)
		{
